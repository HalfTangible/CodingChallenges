...
public class HappyNumber {
    ...
    public boolean happy(int input){
        //Any happy number will have a 1 in its sequence, and every unhappy number will have a 4 in its sequence.
        //^This is contradicted by our examples, so it's not worth paying attention to or taking account of

        //First off we need every digit from input.
        //Convert to a string, check its length. If it's length 1, then we can send back true/false based on that.
        //If not, we add every digit together and send them along.
        ...
        /*if(input == 1)
            ...
            return happy(newInput);
        }
        else
            return false;*/

        //Okay I completely misunderstood the point here.
